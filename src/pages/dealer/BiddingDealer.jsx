...
const BiddingDealer = () => {
  const{data : bidding,isLoading,error} = useBiddingAllCardQuery()
  console.log(bidding)
if(isLoading){
  return <p>Loading..</p>
}
...
const columns = [
...

  {
    ...
    //         {/* <Link to={`/dealer/${id}/car/edit/${cell.row.values.beadingCarId}`}
    //         > */}
    //           <svg
    //             xmlns="http://www.w3.org/2000/svg"
    //             fill="none"
    ...
    <>
      ...
      <CardHeader floated={false} shadow={false} className="rounded-none">
        ...
        <CardBody className="overflow-scroll px-0">
          <TableComponent columns={columns} data={bidding} />
        </CardBody>
