...
export function AccordionCustom() {
  ...
  return (
    <>
      <div className="text-2xl md:text-4xl md:text-center"> Frequently Asked Question </div>
      <Accordion open={open === 1} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(1)}>When and Where can I take a test drive?</AccordionHeader>
      ...
      <Accordion open={open === 2} animate={CUSTOM_ANIMATION}>
        <AccordionHeader  className="text-lg md:text-xl "onClick={() => handleOpen(2)}>What benefits CarBySell give us?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
      ...
      <Accordion open={open === 3} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(3)}>How do I book a car of my choice?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
      ...
      <Accordion open={open === 4} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(4)}>Is replacement option is available?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
      ...
      <Accordion open={open === 5} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(5)}>Will CarBySell give us history of vehicle?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
      ...
      <Accordion open={open === 6} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(6)}>Will CarBySell help me with car finance?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
      ...
      <Accordion open={open === 7} animate={CUSTOM_ANIMATION}>
        <AccordionHeader className="text-lg md:text-xl " onClick={() => handleOpen(7)}>Will CarBySell Give us extended warrenty?</AccordionHeader>
        <AccordionBody className="text-sm md:text-xl">
        Protect your investment with our extended warranty options.
        Get peace of mind knowing that your second-hand car is covered against unexpected repairs.
        </AccordionBody>
      </Accordion>
